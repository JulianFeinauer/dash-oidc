...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CompaniesApi()
        api_instance.companies_list  # this is an instance of the class Endpoint
        api_instance.companies_list()  # this invokes api_instance.companies_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.companies_list.callable or self.callable in this class
